...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 05, 2024 at 05:19 AM
...
INSERT INTO `provider` (`pid`, `fname`, `mname`, `lname`, `gender`, `age`, `email`, `con_num`, `alt_num`, `address`, `password`, `acc_type`, `pan_card`, `acc_num`, `ifsc`, `experience`, `photo`, `certificate`, `aadhaar`, `created_at`, `updated_at`, `is_deleted`) VALUES
(1, 'John', 'M', 'Doe', 'Male', 35, 'john.doe@example.com', 9876543210, NULL, '123 Main St, Springfield', 'hashed_password', 'Savings', 'ABCDE1234F', 123456789012, 'SBIN0001234', '5 years as a plumber', 'john_photo.jpg', 'plumber_certificate.jpg', 'john_aadhaar.jpg', '2024-09-01 04:30:00', '2024-09-01 04:30:00', 0),
(2, 'Jane', 'A', 'Smith', 'Female', 29, 'jane.smith@example.com', 9876543211, NULL, '456 Market St, Springfield', 'hashed_password', 'Current', 'XYZDE5678K', 123456789013, 'HDFC0005678', '3 years as a hairstylist', 'jane_photo.jpg', 'stylist_certificate.jpg', 'jane_aadhaar.jpg', '2024-09-01 05:30:00', '2024-09-01 05:30:00', 0);
...
INSERT INTO `services` (`sid`, `sname`, `srating`, `sprice`, `sduration`, `sdes`, `scategory`, `simage`, `sattraction`, `sdiscount`, `screate`, `created_by`, `updated_by`) VALUES
(1, 'Basic Car Wash', 4, 500, '1 hr', 'A quick and thorough car wash.', 3, 'assets\\images\\services\\img_1.jpg', 'discount', 10, '2024-09-01 01:00:00', 1, 1),
...
(13, 'Basic Oil Change', 4, 800, '30 min', 'Oil change with standard engine oil.', 3, 'assets\\images\\services\\img_13.jpg', 'discount', 10, '2024-09-01 03:00:00', 1, 2),
(14, 'Premium Oil Change', 5, 1200, '45 min', 'Oil change with high-performance synthetic oil.', 3, 'assets\\images\\services\\img_14.jpg', 'exclusive', 15, '2024-09-03 05:00:00', 1, 2),
(15, 'Deluxe Car Wash', 5, 800, '2 hr', 'Includes wax and tire shine.', 3, 'assets\\images\\services\\img_15.jpg', 'sale', 20, '2024-09-02 01:00:00', 1, 2);
...
INSERT INTO `users` (`uid`, `fname`, `mname`, `lname`, `email`, `password`, `con_num`, `alt_num`, `address`, `isverified`, `is_deleted`, `ucreate`, `role_id`) VALUES
(2, 'Bob', NULL, 'Williams', 'bob.williams@example.com', 'hashed_password', 9123456790, NULL, '1010 Maple St, Springfield', 'false', 0, '2024-09-01 08:30:00', 2),
(4, 'Pritam', 'asde', 'Mahata', 'pritammahata12@gmail.com', '@pritam123', 7384026949, 6296387532, 'Sonarpur ghasiara natun pally', 'false', 0, '2024-09-04 16:01:18', NULL),
(5, 'asd', '', 'asd', 'asdasd@as.g', '123', 123123, 1231231, '12312asdasd', 'false', 0, '2024-09-04 16:09:30', 1),
(8, '123', '1', '123', 'test@gmail.com', '$2y$10$xBh05JMX.BzOfwz7gGgHuOrQB/X5keE4C59t41L26Jpx4Lm4Ro2bC', 312312313, 123123123, 'qweqweds asd as', 'false', 0, '2024-09-04 18:48:17', 1);
