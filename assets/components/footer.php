    ...
    <div class="footer-nav">
      <div class="container">
        <ul class="footer-nav-list">
          ...
          <li class="footer-nav-item">
            <a href="#" class="footer-nav-link">ServiceHUB impact</a>
          </li>
          <li class="footer-nav-item">
        ...
        <ul class="footer-nav-list">
          <li class="footer-nav-item">
            <h2 class="nav-title">For customers</h2>
          </li>
          <li class="footer-nav-item">
            <a href="#" class="footer-nav-link">UC reviews</a>
          </li>
          <li class="footer-nav-item">
            <a href="#" class="footer-nav-link">Categories near you</a>
          </li>
          <li class="footer-nav-item">
        ...
        <ul class="footer-nav-list">
          ...
          <li class="footer-nav-item">
            <a href="#" class="footer-nav-link">New elements</a>
          </li>
          <li class="footer-nav-item">
