...
if (isset($_POST['update'])) {
    ...
    $sfeatures = $_POST['sfeatures'];
    upload_image();
    $sql = "UPDATE services SET sname='$sname', scategory = '$scategory', sduration='$sduration', sprice='$sprice', sdiscount='$sdiscount', sdes='$sdes', sfeatures='$sfeatures', simage = '$simage' WHERE sid=$sid";
    if (mysqli_query($conn, $sql)) {
                ...
                <div class="row">
                    ...
                    <div class="col-auto my-1">
                        ...
                        <select class="form-select" id="scategory" name="scategory">
                            <?php
                            $sql = "SELECT subcat, subcatname FROM sub_category";
                            ...
                            if ($result->num_rows > 0) {
                                while ($row = $result->fetch_assoc()) {
                                    echo "<option value='" . $row['subcat'] . "'>" . $row['subcatname'] . "</option>";
                                }
                            } else {
